...
def home(request):
    url='http://api.openweathermap.org/data/2.5/weather?q={},&appid=6b0db3384a74beb18811937675047b4c&units=metric'
        ...
        if form.is_valid():
            ...
            if CCity==0:
                ...
                if res['cod']==200:
                    ...
                    messages.error(request,"Oops City Does Not Exists..!!!!")
            else:
                messages.error(request,"Oops City Alredy Exists..!!!!")
